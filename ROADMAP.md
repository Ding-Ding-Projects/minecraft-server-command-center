...
- [x] Create and verify the external archive `minecraft-server-command-center-20260918T174100Z.7z` at 5,315,254 bytes with 259 files, 77 folders, and a non-empty `.git` directory before the final metadata-only receipt update.
