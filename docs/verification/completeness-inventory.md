...
| Paper CLI category mapping | `src/shared/server-draft.ts`, `src/main/cli-catalog.ts`, `src/renderer/main.ts` | [Paper and Spigot CLI guidance](../server-configuration/paper-spigot-cli.md) | Shared, fallback, and renderer source inspected | Not recorded |
| Spigot unavailable/compatibility catalogue | `src/main/cli-catalog.ts`, `src/renderer/main.ts` | [Paper and Spigot CLI guidance](../server-configuration/paper-spigot-cli.md) | Fallback and renderer source inspected | Not recorded |
| Copyable tokenized argv preview | `src/shared/server-draft.ts`, `src/renderer/main.ts` | [Paper and Spigot CLI guidance](../server-configuration/paper-spigot-cli.md) | Shared token generator and renderer source inspected | Not recorded |
