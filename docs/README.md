...
- [Universal settings](reference/universal-settings.md) — the shared settings schema, local storage, bounded companion and desktop personal-vocabulary file contract, School mode, logo boundary, and evidence limits.
